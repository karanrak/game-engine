...
public:
	explicit Character(int id = 0, const sf::Vector2f dims = sf::Vector2f(50.f, 100.f), sf::Vector2f pos = sf::Vector2f(50.f, 50.f), bool visible = true, sf::Color color = sf::Color::Yellow, int screenno = 1) :
		m_id(id), m_screenno(screenno), Colorable(dims, pos, visible, color)
	{
